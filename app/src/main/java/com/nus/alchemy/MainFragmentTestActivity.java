...
public class MainFragmentTestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //fragment
    final Fragment myProfile = new ProfileFragment();
    //final Fragment myEvent = new MyEventFragment();
    //final Fragment todayEvent = new TodayEventFragment();
    //final Fragment myChat = new ChatFragment();
    final FragmentManager fm = getSupportFragmentManager();
    Fragment active = myProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationView navigation = (BottomNavigationView) findViewById(R.id.bottomNavigationView_fragment);
